...
--ArmuriePoliceLang["fr"] = {   --Noubliez pas de changer ce qui est entre parenthèse, Ce que vous écrirez là dedans , Doit êtres la même chose que dans le fichier config
--	APTitle = "Armurie",  Titre qui tourne audessu de l'objet.                                 --|
--	APLabel = "Armurie",                                                                                |
--	APButton = "Acheter",                                                                               |
